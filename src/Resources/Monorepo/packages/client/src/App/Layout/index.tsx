...
import { LoadingScreen, Modal } from '@bar/ui-kit';
...
import { defaultTheme, ITheme } from '@bar/ui-kit/src/Theme';
import GlobalStyles from '@bar/ui-kit/src/Theme/GlobalStyles';
